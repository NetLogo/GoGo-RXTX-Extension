...
RXTXcomm.jar:
	...
	curl -f -s 'http://ccl.northwestern.edu/devel/rxtx-2.2pre2-bins/win32/rxtxSerial.dll' -o lib/Windows32/rxtxSerial.dll
	curl -f -s 'http://ccl.northwestern.edu/devel/rxtx-2.2pre2-bins/win64/rxtxSerial.dll' -o lib/Windows64/rxtxSerial.dll
